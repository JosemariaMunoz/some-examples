...
function App() {
  ...
  const steps = [
    {
      label: intl.formatMessage({id: 'traffic-ticket-data'}),
      description: intl.formatMessage({id: 'traffic-ticket-data-description'})
    },
    {
    ...
    {
      label: intl.formatMessage({id: 'payment-form'}),
      description: intl.formatMessage({id: 'payment-form-description'})
    },
    {
