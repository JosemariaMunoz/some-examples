...
class TrafficTicketCollectorApp extends HTMLElement {
  connectedCallback() {
...
const ELEMENT_ID = 'traffic-ticket-collector';

if (!customElements.get(ELEMENT_ID)) {
  customElements.define(ELEMENT_ID, TrafficTicketCollectorApp);
}