...
<head>
	...
	<#if show_vertical_menu>
		<link rel="stylesheet" href="${javascript_folder}/assets/vendor/metisMenu/metisMenu.css">
	</#if>
	<!-- END VENDOR CSS -->
...
<#if show_dockbar>
	...
	<div class="d-flex flex-column flex-fill" id="wrapper">
		<nav class="navbar navbar-default" id="vnav-ham">
		<div class="container-fluid">
			<div class="align-items-center d-flex">
				<div class="mb-0 navbar-btn">
		...
		<!-- LEFT SIDEBAR -->
		<#if show_vertical_menu>
			<div id="left-sidebar" class="sidebar ${left_sidebar_css_class}">
		...
		<#if show_footer>		
			<footer class="footer-bg footer-text-color ${footer_css_class}" id="footer" role="contentinfo">
				<div class="container">
					<div class="row">
						<div class="col-md-12 text-center text-md-left">
							<@liferay.language key="powered-by" />

							<a class="text-gray" href="http://www.liferay.com" rel="external">Liferay</a>
						</div>
					</div>
				</div>
			</footer>
...
<!-- Javascript -->
<#if show_vertical_menu>
	<script src="${javascript_folder}/assets/vendor/jquery/jquery.min.js"></script>
	<script src="${javascript_folder}/assets/vendor/metisMenu/metisMenu.js"></script>
	<script src="${javascript_folder}/assets/vendor/jquery-slimscroll/jquery.slimscroll.min.js"></script>
	<script src="${javascript_folder}/assets/scripts/common.js"></script>
</#if>
...
<#if show_vertical_menu && show_header>
	<script data-senna-track="permanent" id="vnavJS" src="${javascript_folder}/vnav.js" type="text/javascript"></script>
</#if>
<!-- End Javascript -->
</body>
